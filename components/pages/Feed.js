import { View, Text, ScrollView, TextInput, Button, Image, Pressable } from 'react-native';
...
const Feed = () => {
  ...
  return (
    <ScrollView style={{ padding: 20, backgroundColor: "white" }}>
      ...
      <View>
        <View style={{borderBottomWidth: 1, borderBottomColor: "gray",marginBottom: 10,flexDirection:"row",alignItems:"center",justifyContent:"space-between" }}>
          <TextInput placeholder='Write Post' style={{ fontSize: 16,flexGrow:1 }} multiline />
          <IonIcons name='attach' size={24} onPress={()=>alert("get attachment")} />
        </View>
        <Button title='Post' />
      </View>

      {/* individual post here */}
      <View style={{ borderWidth: 1, borderColor: "gray", marginVertical: 10 }}>
